    ...
    <section className="py-32 bg-[#0B0C15] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-brand-text text-lg">See what our community is saying about Rovoxa.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((testimonial, idx) => (
            <div 
                key={idx} 
                className="bg-[#11131A] p-8 md:p-10 rounded-2xl border border-white/5 hover:border-white/10 transition-colors flex flex-col items-center text-center group"
            >
